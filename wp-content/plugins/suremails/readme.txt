...
v2.0.1 - 14-July-2026
- Improvement: SureContact - Added a quick "Add Sender" option in the connections header.
- Improvement: Internal enhancements to SureContact integration and email analytics.
- Fix: SureContact - Fixed the user name not being sent during connection provisioning.
...
- Fix: Dashboard line chart rendered as an empty area after updating to v1.9.4.
...
v1.9.2 - 21-January-2026
- Improvement: Added a setting to choose where the SureMail menu appears in the WordPress admin.

v1.9.1 - 26-November-2025
- Fix: Addressed a security bug. Props to Wordfence for reporting it responsibly.

v1.9.0 04-November-2025
...
v1.7.0 - 09-June-2025
- New: Introduced an Onboarding process to help users get started quickly.
- Fix: Elastic Email Connection: Improved the reply-to handling logic.
- Improvement: Improved the initial connection admin notice so that once dismissed, it stays hidden for 15 days.
